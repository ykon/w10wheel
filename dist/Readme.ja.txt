...
履歴:
        2017-10-22: v2.6.2: Scalaとexewrapを更新 (Java9との互換性向上)
        2017-10-15: v2.6.1: 細かい改良 (コマンドライン引数、エラーハンドリング、デフォルト値変更) + ライブラリ更新
...
回復操作:
        スクロールモードのまま戻らくなったら、
        Escape キーを押しながらクリックを試してください。
        状態を初期化して、スクロールモードを終了します。
